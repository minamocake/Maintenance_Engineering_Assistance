...
function c7(){return dF.apply(null,arguments)
}function bK(af){dF=af
}function aj(af){return af instanceof Array||Object.prototype.toString.call(af)==="[object Array]"
}function hA(af){return af instanceof Date||Object.prototype.toString.call(af)==="[object Date]"
}function cx(af,be){var az=[],ar;
for(ar=0;
ar<af.length;
++ar){az.push(be(af[ar],ar))
}return az
}function fF(ar,af){return Object.prototype.hasOwnProperty.call(ar,af)
}function iw(ar,af){for(var az in af){if(fF(af,az)){ar[az]=af[az]
}}if(fF(af,"toString")){ar.toString=af.toString
}if(fF(af,"valueOf")){ar.valueOf=af.valueOf
}return ar
}function g6(az,be,af,ar){return aA(az,be,af,ar,true).utc()
}function d4(){return{empty:false,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:false,invalidMonth:null,invalidFormat:false,userInvalidated:false,iso:false,parsedDateParts:[],meridiem:null}
}function cb(af){if(af._pf==null){af._pf=d4()
}return af._pf
}var fK;
if(Array.prototype.some){fK=Array.prototype.some
}else{fK=function(ar){var be=Object(this);
var af=be.length>>>0;
for(var az=0;
az<af;
az++){if(az in be&&ar.call(this,be[az],az,be)){return true
}}return false
}
}function a7(af){if(af._isValid==null){var ar=cb(af);
var az=fK.call(ar.parsedDateParts,function(be){return be!=null
});
...
}function ev(ar){var af=g6(NaN);
if(ar!=null){iw(cb(af),ar)
}else{cb(af).userInvalidated=true
}return af
}function P(af){return af===void 0
}var eN=c7.momentProperties=[];
function w(bg,be){var af,az,ar;
if(!P(be._isAMomentObject)){bg._isAMomentObject=be._isAMomentObject
}if(!P(be._i)){bg._i=be._i
}if(!P(be._f)){bg._f=be._f
}if(!P(be._l)){bg._l=be._l
}if(!P(be._strict)){bg._strict=be._strict
}if(!P(be._tzm)){bg._tzm=be._tzm
}if(!P(be._isUTC)){bg._isUTC=be._isUTC
}if(!P(be._offset)){bg._offset=be._offset
}if(!P(be._pf)){bg._pf=cb(be)
}if(!P(be._locale)){bg._locale=be._locale
}if(eN.length>0){for(af in eN){az=eN[af];
ar=be[az];
if(!P(ar)){bg[az]=ar
}}}return bg
}var fw=false;
function hs(af){w(this,af);
this._d=new Date(af._d!=null?af._d.getTime():NaN);
if(fw===false){fw=true;
c7.updateOffset(this);
fw=false
}}function dG(af){return af instanceof hs||(af!=null&&af._isAMomentObject!=null)
}function fB(af){if(af<0){return Math.ceil(af)
}else{return Math.floor(af)
}}function eI(af){var az=+af,ar=0;
if(az!==0&&isFinite(az)){ar=fB(az)
}return ar
}function dk(bn,bg,ar){var af=Math.min(bn.length,bg.length),az=Math.abs(bn.length-bg.length),bo=0,be;
for(be=0;
be<af;
be++){if((ar&&bn[be]!==bg[be])||(!ar&&eI(bn[be])!==eI(bg[be]))){bo++
}}return bo+az
}function fm(af){if(c7.suppressDeprecationWarnings===false&&(typeof console!=="undefined")&&console.warn){console.warn("Deprecation warning: "+af)
}}function gY(ar,af){var az=true;
...
function ik(af,ar){if(c7.deprecationHandler!=null){c7.deprecationHandler(af,ar)
}if(!av[af]){fm(ar);
av[af]=true
}}c7.suppressDeprecationWarnings=false;
c7.deprecationHandler=null;
function b2(af){return af instanceof Function||Object.prototype.toString.call(af)==="[object Function]"
}function D(af){return Object.prototype.toString.call(af)==="[object Object]"
}function gi(af){var az,ar;
for(ar in af){az=af[ar];
if(b2(az)){this[ar]=az
}else{this["_"+ar]=az
}}this._config=af;
this._ordinalParseLenient=new RegExp(this._ordinalParse.source+"|"+(/\d{1,2}/).source)
}function gL(az,af){var ar=iw({},az),be;
...
}function eh(af){if(af!=null){this.set(af)
}}var dd;
if(Object.keys){dd=Object.keys
}else{dd=function(az){var ar,af=[];
for(ar in az){if(fF(az,ar)){af.push(ar)
}}return af
}
}var cJ={};
var eW;
function fJ(af){return af?af.toLowerCase().replace("_","-"):af
}function eU(bn){var be=0,ar,bg,af,az;
while(be<bn.length){az=fJ(bn[be]).split("-");
ar=az.length;
bg=fJ(bn[be+1]);
bg=bg?bg.split("-"):null;
while(ar>0){af=bl(az.slice(0,ar).join("-"));
if(af){return af
}if(bg&&bg.length>=ar&&dk(az,bg,true)>=ar-1){break
}ar--
}be++
}return null
}function bl(af){var az=null;
if(!cJ[af]&&(typeof module!=="undefined")&&module&&module.exports){try{az=eW._abbr;
require("./locale/"+af);
ez(az)
}catch(ar){}}return cJ[af]
}function ez(ar,af){var az;
if(ar){if(P(af)){az=A(ar)
}else{az=eg(ar,af)
}if(az){eW=az
}}return eW._abbr
}function eg(ar,af){if(af!==null){af.abbr=ar;
...
}function A(ar){var af;
if(ar&&ar._locale&&ar._locale._abbr){ar=ar._locale._abbr
}if(!ar){return eW
}if(!aj(ar)){af=bl(ar);
if(af){return af
}ar=[ar]
}return eU(ar)
}function an(){return dd(cJ)
}var eF={};
function dM(az,af){var ar=az.toLowerCase();
eF[ar]=eF[ar+"s"]=eF[af]=az
}function eH(af){return typeof af==="string"?eF[af]||eF[af.toLowerCase()]:undefined
}function gf(az){var ar={},af,be;
for(be in az){if(fF(az,be)){af=eH(be);
if(af){ar[af]=az[be]
}}}return ar
}function gS(af,ar){return function(az){if(az!=null){hB(this,af,az);
c7.updateOffset(this,ar);
return this
}else{return h4(this,af)
}}
}function h4(ar,af){return ar.isValid()?ar._d["get"+(ar._isUTC?"UTC":"")+af]():NaN
}function hB(ar,af,az){if(ar.isValid()){ar._d["set"+(ar._isUTC?"UTC":"")+af](az)
}}function hL(af,az){var ar;
if(typeof af==="object"){for(ar in af){this.set(ar,af[ar])
}}else{af=eH(af);
if(b2(this[af])){return this[af](az)
}}return this
}function dX(bn,bg,ar){var be=""+Math.abs(bn),az=bg-be.length,af=bn>=0;
return(af?(ar?"+":""):"-")+Math.pow(10,Math.max(0,az)).toString().substr(1)+be
}var c1=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;
var c0=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g;
var cY={};
var b8={};
function eb(ar,az,af,bg){var be=bg;
if(typeof bg==="string"){be=function(){return this[bg]()
}
}if(ar){b8[ar]=be
}if(az){b8[az[0]]=function(){return dX(be.apply(this,arguments),az[1],az[2])
}
}if(af){b8[af]=function(){return this.localeData().ordinal(be.apply(this,arguments),ar)
}
}}function ba(af){if(af.match(/\[[\s\S]/)){return af.replace(/^\[|\]$/g,"")
}return af.replace(/\\/g,"")
}function cI(az){var be=az.match(c1),af,ar;
for(af=0,ar=be.length;
af<ar;
af++){if(b8[be[af]]){be[af]=b8[be[af]]
}else{be[af]=ba(be[af])
}}return function(bo){var bg="",bn;
for(bn=0;
bn<ar;
bn++){bg+=be[bn] instanceof Function?be[bn].call(bo,az):be[bn]
}return bg
}
}function aE(af,ar){if(!af.isValid()){return af.localeData().invalidDate()
}ar=cN(ar,af.localeData());
cY[ar]=cY[ar]||cI(ar);
return cY[ar](af)
}function cN(be,af){var ar=5;
function az(bg){return af.longDateFormat(bg)||bg
}c0.lastIndex=0;
while(ar>=0&&c0.test(be)){be=be.replace(c0,az);
c0.lastIndex=0;
ar-=1
}return be
}var bC=/\d/;
...
var bX={};
function ce(af,ar,az){bX[af]=b2(ar)?ar:function(bg,be){return(bg&&az)?az:ar
}
}function cM(ar,af){if(!fF(bX,ar)){return new RegExp(fC(ar))
}return bX[ar](af._strict,af._locale)
}function fC(af){return dN(af.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(ar,bn,bg,be,az){return bn||bg||be||az
}))
}function dN(af){return af.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
}var l={};
function c8(ar,be){var af,az=be;
if(typeof ar==="string"){ar=[ar]
}if(typeof be==="number"){az=function(bg,bn){bn[be]=eI(bg)
}
}for(af=0;
af<ar.length;
af++){l[ar[af]]=az
}}function at(af,ar){c8(af,function(az,bn,be,bg){be._w=be._w||{};
ar(az,be._w,be,bg)
})
}function C(az,af,ar){if(af!=null&&fF(l,az)){l[az](af,ar._a,ar,az)
}}var io=0;
var n=1;
var hx=2;
var h0=3;
...
}else{eJ=function(ar){var af;
for(af=0;
af<this.length;
++af){if(this[af]===ar){return af
}}return -1
}
}function cO(af,ar){return new Date(Date.UTC(af,ar+1,0)).getUTCDate()
}eb("M",["MM",2],"Mo",function(){return this.month()+1
});
...
c8(["M","MM"],function(af,ar){ar[n]=eI(af)-1
});
...
function b9(af,ar){return aj(this._monthsShort)?this._monthsShort[af.month()]:this._monthsShort[dt.test(ar)?"format":"standalone"][af.month()]
}function cd(ar,bo,af){var be,bg,bn,az=ar.toLocaleLowerCase();
...
be<12;
++be){bn=g6([2000,be]);
this._shortMonthsParse[be]=this.monthsShort(bn,"").toLocaleLowerCase();
this._longMonthsParse[be]=this.months(bn,"").toLocaleLowerCase()
}}if(af){if(bo==="MMM"){bg=eJ.call(this._shortMonthsParse,az);
return bg!==-1?bg:null
}else{bg=eJ.call(this._longMonthsParse,az);
return bg!==-1?bg:null
}}else{if(bo==="MMM"){bg=eJ.call(this._shortMonthsParse,az);
if(bg!==-1){return bg
}bg=eJ.call(this._longMonthsParse,az);
return bg!==-1?bg:null
}else{bg=eJ.call(this._longMonthsParse,az);
if(bg!==-1){return bg
}bg=eJ.call(this._shortMonthsParse,az);
return bg!==-1?bg:null
}}}function fh(ar,bn,af){var az,bg,be;
...
return af
}function hY(af){if(af!=null){bN(this,af);
c7.updateOffset(this,true);
return this
}else{return h4(this,"Month")
}}function cV(){return cO(this.year(),this.month())
}var fz=b4;
...
}}function fH(){function bn(br,bo){return bo.length-br.length
}var bg=[],af=[],be=[],ar,az;
for(ar=0;
ar<12;
ar++){az=g6([2000,ar]);
bg.push(this.monthsShort(az,""));
af.push(this.months(az,""));
be.push(this.months(az,""));
be.push(this.monthsShort(az,""))
}bg.sort(bn);
af.sort(bn);
be.sort(bn);
for(ar=0;
...
af[ar]=dN(af[ar]);
be[ar]=dN(be[ar])
}this._monthsRegex=new RegExp("^("+be.join("|")+")","i");
this._monthsShortRegex=this._monthsRegex;
this._monthsStrictRegex=new RegExp("^("+af.join("|")+")","i");
this._monthsShortStrictRegex=new RegExp("^("+bg.join("|")+")","i")
}function eG(af){var az;
var ar=af._a;
if(ar&&cb(af).overflow===-2){az=ar[n]<0||ar[n]>11?n:ar[hx]<1||ar[hx]>cO(ar[io],ar[n])?hx:ar[h0]<0||ar[h0]>24||(ar[h0]===24&&(ar[f9]!==0||ar[aN]!==0||ar[cS]!==0))?h0:ar[f9]<0||ar[f9]>59?f9:ar[aN]<0||ar[aN]>59?aN:ar[cS]<0||ar[cS]>999?cS:-1;
if(cb(af)._overflowDayOfYear&&(az<io||az>hx)){az=hx
}if(cb(af)._overflowWeeks&&az===-1){az=dO
}if(cb(af)._overflowWeekday&&az===-1){az=m
}cb(af).overflow=az
}return af
...
var db=/^\/?Date\((\-?\d+)/i;
function L(ar){var bn,be,br=ar._i,bo=o.exec(br)||bL.exec(br),bs,af,bg,az;
if(bo){cb(ar).iso=true;
for(bn=0,be=eM.length;
bn<be;
bn++){if(eM[bn][1].exec(bo[1])){af=eM[bn][0];
bs=eM[bn][2]!==false;
break
}}if(af==null){ar._isValid=false;
return
}if(bo[3]){for(bn=0,be=d2.length;
bn<be;
bn++){if(d2[bn][1].exec(bo[3])){bg=(bo[2]||" ")+d2[bn][0];
break
}}if(bg==null){ar._isValid=false;
return
}}if(!bs&&bg!=null){ar._isValid=false;
return
}if(bo[4]){if(en.exec(bo[4])){az="Z"
}else{ar._isValid=false;
return
}}ar._f=af+(bg||"")+(az||"");
df(ar)
}else{ar._isValid=false
}}function cc(ar){var af=db.exec(ar._i);
if(af!==null){ar._d=new Date(+af[1]);
return
}L(ar);
if(ar._isValid===false){delete ar._isValid;
c7.createFromInputFallback(ar)
}}c7.createFromInputFallback=gY("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(af){af._d=new Date(af._i+(af._useUTC?" UTC":""))
});
function gM(br,af,bn,bg,bo,be,az){var ar=new Date(br,af,bn,bg,bo,be,az);
if(br<100&&br>=0&&isFinite(ar.getFullYear())){ar.setFullYear(br)
}return ar
}function fP(ar){var af=new Date(Date.UTC.apply(null,arguments));
if(ar<100&&ar>=0&&isFinite(af.getUTCFullYear())){af.setUTCFullYear(ar)
}return af
}eb("Y",0,0,function(){var af=this.year();
return af<=9999?""+af:"+"+af
});
...
ce("YYYYYY",aX,bw);
c8(["YYYYY","YYYYYY"],io);
c8("YYYY",function(af,ar){ar[io]=af.length===2?c7.parseTwoDigitYear(af):eI(af)
});
c8("YY",function(af,ar){ar[io]=c7.parseTwoDigitYear(af)
});
c8("Y",function(af,ar){ar[io]=parseInt(af,10)
});
function f6(af){return gA(af)?366:365
}function gA(af){return(af%4===0&&af%100!==0)||af%400===0
}c7.parseTwoDigitYear=function(af){return eI(af)+(eI(af)>68?1900:2000)
};
var eq=gS("FullYear",true);
function eS(){return gA(this.year())
}function cm(ar,bg,be){var af=7+bg-be,az=(7+fP(ar,0,af).getUTCDay()-bg)%7;
return -az+af-1
}function cL(be,ar,az,ca,br){var bs=(7+az-ca)%7,af=cm(be,ca,br),bn=1+7*(ar-1)+bs+af,bo,bg;
if(bn<=0){bo=be-1;
bg=f6(bo)+bn
...
}function O(ar,bg,az){var af=cm(ar,bg,az),be=cm(ar+1,bg,az);
return(f6(ar)-af+be)/7
}function gN(ar,af,az){if(ar!=null){return ar
}if(af!=null){return af
}return az
}function bW(ar){var af=new Date(c7.now());
if(ar._useUTC){return[af.getUTCFullYear(),af.getUTCMonth(),af.getUTCDate()]
}return[af.getFullYear(),af.getMonth(),af.getDate()]
}function h(bg){var bn,be,az=[],ar,af;
if(bg._d){return
}ar=bW(bg);
if(bg._w&&bg._a[hx]==null&&bg._a[n]==null){e4(bg)
}if(bg._dayOfYear){af=gN(bg._a[io],ar[io]);
if(bg._dayOfYear>f6(af)){cb(bg)._overflowDayOfYear=true
}be=fP(af,0,bg._dayOfYear);
bg._a[n]=be.getUTCMonth();
bg._a[hx]=be.getUTCDate()
}for(bn=0;
bn<3&&bg._a[bn]==null;
++bn){bg._a[bn]=az[bn]=ar[bn]
}for(;
bn<7;
bn++){bg._a[bn]=az[bn]=(bg._a[bn]==null)?(bn===2?1:0):bg._a[bn]
}if(bg._a[h0]===24&&bg._a[f9]===0&&bg._a[aN]===0&&bg._a[cS]===0){bg._nextDay=true;
bg._a[h0]=0
}bg._d=(bg._useUTC?fP:gM).apply(null,az);
if(bg._tzm!=null){bg._d.setUTCMinutes(bg._d.getUTCMinutes()-bg._tzm)
}if(bg._nextDay){bg._a[h0]=24
}}function e4(az){var bn,af,ar,be,bs,bo,br,bg;
bn=az._w;
...
}}}function f2(af){var bg,az,be,ar,bn;
if(af._f.length===0){cb(af).invalidFormat=true;
af._d=new Date(NaN);
return
}for(ar=0;
ar<af._f.length;
ar++){bn=0;
bg=w({},af);
if(af._useUTC!=null){bg._useUTC=af._useUTC
}bg._f=af._f[ar];
df(bg);
if(!a7(bg)){continue
}bn+=cb(bg).charsLeftOver;
bn+=cb(bg).unusedTokens.length*10;
cb(bg).score=bn;
if(be==null||bn<be){be=bn;
az=bg
}}iw(af,az||bg)
}function bY(af){if(af._d){return
}var ar=gf(af._i);
af._a=cx([ar.year,ar.month,ar.day||ar.date,ar.hour,ar.minute,ar.second,ar.millisecond],function(az){return az&&parseInt(az,10)
});
h(af)
}function aU(af){var ar=new hs(eG(cC(af)));
if(ar._nextDay){ar.add(1,"d");
ar._nextDay=undefined
}return ar
}function cC(ar){var af=ar._i,az=ar._f;
...
}else{if(aj(af)){ar._a=cx(af.slice(0),function(az){return parseInt(az,10)
});
h(ar)
}else{if(typeof(af)==="object"){bY(ar)
}else{if(typeof(af)==="number"){ar._d=new Date(af)
}else{c7.createFromInputFallback(ar)
}}}}}}}function aA(be,bg,af,az,ar){var bn={};
if(typeof(af)==="boolean"){az=af;
af=undefined
}bn._isAMomentObject=true;
bn._useUTC=bn._isUTC=ar;
bn._l=af;
bn._i=be;
bn._f=bg;
bn._strict=az;
return aU(bn)
}function gJ(az,be,af,ar){return aA(az,be,af,ar,false)
}var eA=gY("moment().min is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(){var af=gJ.apply(null,arguments);
if(this.isValid()&&af.isValid()){return af<this?this:af
}else{return ev()
}});
var hm=gY("moment().max is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(){var af=gJ.apply(null,arguments);
if(this.isValid()&&af.isValid()){return af>this?this:af
}else{return ev()
}});
function ix(az,be){var ar,af;
if(be.length===1&&aj(be[0])){be=be[0]
}if(!be.length){return gJ()
}ar=be[0];
for(af=1;
af<be.length;
++af){if(!be[af].isValid()||be[af][az](ar)){ar=be[af]
}}return ar
}function v(){var af=[].slice.call(arguments,0);
return ix("isBefore",af)
}function cr(){var af=[].slice.call(arguments,0);
return ix("isAfter",af)
}var ed=function(){return Date.now?Date.now():+(new Date())
};
function gj(bn){var br=gf(bn),bo=br.year||0,ar=br.quarter||0,az=br.month||0,af=br.week||0,cs=br.day||0,bs=br.hour||0,bg=br.minute||0,ca=br.second||0,be=br.millisecond||0;
this._milliseconds=+be+ca*1000+bg*60000+bs*1000*60*60;
this._days=+cs+af*7;
this._months=+az+ar*3+bo*12;
this._data={};
this._locale=A();
this._bubble()
}function aD(af){return af instanceof gj
}function cG(af,ar){eb(af,0,0,function(){var be=this.utcOffset();
var az="+";
if(be<0){be=-be;
az="-"
}return az+dX(~~(be/60),2)+ar+dX(~~(be)%60,2)
})
}cG("Z",":");
cG("ZZ","");
ce("Z",em);
ce("ZZ",em);
c8(["Z","ZZ"],function(af,az,ar){ar._useUTC=true;
ar._tzm=u(em,af)
});
var hT=/([\+\-]|\d\d)/gi;
function u(bn,ar){var be=((ar||"").match(bn)||[]);
var af=be[be.length-1]||[];
var bg=(af+"").match(hT)||["-",0,0];
var az=+(bg[1]*60)+eI(bg[2]);
return bg[0]==="+"?az:-az
}function bm(af,ar){var az,be;
if(ar._isUTC){az=ar.clone();
be=(dG(af)||hA(af)?af.valueOf():gJ(af).valueOf())-az.valueOf();
az._d.setTime(az._d.valueOf()+be);
c7.updateOffset(az,false);
return az
}else{return gJ(af).local()
}}function bG(af){return -Math.round(af._d.getTimezoneOffset()/15)*15
...
}}function fL(af,ar){if(af!=null){if(typeof af!=="string"){af=-af
}this.utcOffset(af,ar);
return this
}else{return -this.utcOffset()
}}function bS(af){return this.utcOffset(0,af)
}function fN(af){if(this._isUTC){this.utcOffset(0,af);
this._isUTC=false;
if(af){this.subtract(bG(this),"m")
}}return this
}function dC(){if(this._tzm){this.utcOffset(this._tzm)
}else{if(typeof this._i==="string"){this.utcOffset(u(cP,this._i))
}}return this
}function bk(af){if(!this.isValid()){return false
}af=af?gJ(af).utcOffset():0;
return(this.utcOffset()-af)%60===0
}function bF(){return(this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset())
}function d(){if(!P(this._isDSTShifted)){return this._isDSTShifted
}var ar={};
w(ar,this);
ar=cC(ar);
if(ar._a){var af=ar._isUTC?g6(ar._a):gJ(ar._a);
this._isDSTShifted=this.isValid()&&dk(ar._a,af.toArray())>0
}else{this._isDSTShifted=false
}return this._isDSTShifted
}function fR(){return this.isValid()?!this._isUTC:false
}function c4(){return this.isValid()?this._isUTC:false
}function f0(){return this.isValid()?this._isUTC&&this._offset===0:false
}var au=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/;
...
function iq(az,af){var ar=az&&parseFloat(az.replace(",","."));
return(isNaN(ar)?0:ar)*af
}function fW(az,af){var ar={milliseconds:0,months:0};
ar.months=af.month()-az.month()+(af.year()-az.year())*12;
if(az.clone().add(ar.months,"M").isAfter(af)){--ar.months
}ar.milliseconds=+af-+(az.clone().add(ar.months,"M"));
return ar
}function cX(az,af){var ar;
if(!(az.isValid()&&af.isValid())){return{milliseconds:0,months:0}
}af=bm(af,az);
if(az.isBefore(af)){ar=fW(az,af)
}else{ar=fW(af,az);
ar.milliseconds=-ar.milliseconds;
ar.months=-ar.months
}return ar
}function hb(af){if(af<0){return Math.round(-1*af)*-1
}else{return Math.round(af)
}}function bZ(ar,af){return function(bn,bg){var be,az;
if(bg!==null&&!isNaN(+bg)){ik(af,"moment()."+af+"(period, number) is deprecated. Please use moment()."+af+"(number, period).");
az=bn;
bn=bg;
bg=az
}bn=typeof bn==="string"?+bn:bn;
be=gX(bn,bg);
b(this,be,ar);
return this
}
}function b(az,bn,bg,be){var ar=bn._milliseconds,bo=hb(bn._days),af=hb(bn._months);
if(!az.isValid()){return
}be=be==null?true:be;
if(ar){az._d.setTime(az._d.valueOf()+ar*bg)
}if(bo){hB(az,"Date",h4(az,"Date")+bo*bg)
}if(af){bN(az,h4(az,"Month")+af*bg)
}if(be){c7.updateOffset(az,bo||af)
}}var dP=bZ(1,"add");
var bQ=bZ(-1,"subtract");
function dK(bo,af){var be=bo||gJ(),az=bm(be,this).startOf("day"),bn=this.diff(az,"days",true),bg=bn<-6?"sameElse":bn<-1?"lastWeek":bn<0?"lastDay":bn<1?"sameDay":bn<2?"nextDay":bn<7?"nextWeek":"sameElse";
var ar=af&&(b2(af[bg])?af[bg]():af[bg]);
return this.format(ar||this.localeData().calendar(bg,this,gJ(be)))
}function fM(){return new hs(this)
}function ek(ar,af){var az=dG(ar)?ar:gJ(ar);
if(!(this.isValid()&&az.isValid())){return false
}af=eH(!P(af)?af:"millisecond");
if(af==="millisecond"){return this.valueOf()>az.valueOf()
}else{return az.valueOf()<this.clone().startOf(af).valueOf()
}}function ih(ar,af){var az=dG(ar)?ar:gJ(ar);
if(!(this.isValid()&&az.isValid())){return false
}af=eH(!P(af)?af:"millisecond");
if(af==="millisecond"){return this.valueOf()<az.valueOf()
}else{return this.clone().endOf(af).valueOf()<az.valueOf()
}}function hp(be,az,af,ar){ar=ar||"()";
return(ar[0]==="("?this.isAfter(be,af):!this.isBefore(be,af))&&(ar[1]===")"?this.isBefore(az,af):!this.isAfter(az,af))
}function ew(ar,af){var be=dG(ar)?ar:gJ(ar),az;
if(!(this.isValid()&&be.isValid())){return false
}af=eH(af||"millisecond");
if(af==="millisecond"){return this.valueOf()===be.valueOf()
}else{az=be.valueOf();
return this.clone().startOf(af).valueOf()<=az&&az<=this.clone().endOf(af).valueOf()
}}function h3(ar,af){return this.isSame(ar,af)||this.isAfter(ar,af)
}function ic(ar,af){return this.isSame(ar,af)||this.isBefore(ar,af)
}function S(be,az,af){var bn,bg,bo,ar;
...
}function hh(ar,af){var bn=((af.year()-ar.year())*12)+(af.month()-ar.month()),az=ar.clone().add(bn,"months"),be,bg;
if(af-az<0){be=ar.clone().add(bn-1,"months");
bg=(af-az)/(az-be)
}else{be=ar.clone().add(bn+1,"months");
bg=(af-az)/(be-az)
}return -(bn+bg)||0
}c7.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";
c7.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";
function gC(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")
}function ee(){var af=this.clone().utc();
if(0<af.year()&&af.year()<=9999){if(b2(Date.prototype.toISOString)){return this.toDate().toISOString()
}else{return aE(af,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
}}else{return aE(af,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
}}function hO(ar){if(!ar){ar=this.isUtc()?c7.defaultFormatUtc:c7.defaultFormat
}var af=aE(this,ar);
return this.localeData().postformat(af)
}function gm(ar,af){if(this.isValid()&&((dG(ar)&&ar.isValid())||gJ(ar).isValid())){return gX({to:this,from:ar}).locale(this.locale()).humanize(!af)
}else{return this.localeData().invalidDate()
}}function gg(af){return this.from(gJ(),af)
}function aK(ar,af){if(this.isValid()&&((dG(ar)&&ar.isValid())||gJ(ar).isValid())){return gX({from:this,to:ar}).locale(this.locale()).humanize(!af)
}else{return this.localeData().invalidDate()
}}function bI(af){return this.to(gJ(),af)
}function iC(ar){var af;
if(ar===undefined){return this._locale._abbr
}else{af=A(ar);
if(af!=null){this._locale=af
}return this
}}var H=gY("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(af){if(af===undefined){return this.localeData()
}else{return this.locale(af)
}});
function gn(){return this._locale
}function dB(af){af=eH(af);
switch(af){case"year":this.month(0);
case"quarter":case"month":this.date(1);
case"week":case"isoWeek":case"day":case"date":this.hours(0);
case"hour":this.minutes(0);
case"minute":this.seconds(0);
case"second":this.milliseconds(0)
}if(af==="week"){this.weekday(0)
}if(af==="isoWeek"){this.isoWeekday(1)
}if(af==="quarter"){this.month(Math.floor(this.month()/3)*3)
}return this
}function hE(af){af=eH(af);
if(af===undefined||af==="millisecond"){return this
}if(af==="date"){af="day"
}return this.startOf(af).add(1,(af==="isoWeek"?"week":af)).subtract(1,"ms")
}function aO(){return this._d.valueOf()-((this._offset||0)*60000)
}function cK(){return Math.floor(this.valueOf()/1000)
}function e3(){return this._offset?new Date(this.valueOf()):this._d
}function gc(){var af=this;
return[af.year(),af.month(),af.date(),af.hour(),af.minute(),af.second(),af.millisecond()]
}function go(){var af=this;
return{years:af.year(),months:af.month(),date:af.date(),hours:af.hours(),minutes:af.minutes(),seconds:af.seconds(),milliseconds:af.milliseconds()}
}function fe(){return this.isValid()?this.toISOString():null
}function hH(){return a7(this)
}function f3(){return iw({},cb(this))
}function ef(){return cb(this).overflow
}function ij(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}
}eb(0,["gg",2],0,function(){return this.weekYear()%100
});
eb(0,["GG",2],0,function(){return this.isoWeekYear()%100
});
function ap(ar,af){eb(0,[ar,ar.length],0,af)
}ap("gggg","weekYear");
ap("ggggg","weekYear");
ap("GGGG","isoWeekYear");
...
at(["gg","GG"],function(af,be,ar,az){be[az]=c7.parseTwoDigitYear(af)
});
function cB(af){return d5.call(this,af,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)
}function gz(af){return d5.call(this,af,this.isoWeek(),this.isoWeekday(),1,4)
}function fg(){return O(this.year(),1,4)
}function Q(){var af=this.localeData()._week;
return O(this.year(),af.dow,af.doy)
}function d5(af,ar,be,bn,bg){var az;
if(af==null){return ht(this,bn,bg).year
}else{az=O(af,bn,bg);
if(ar>az){ar=az
}return b3.call(this,af,ar,be,bn,bg)
}}function b3(az,ar,bg,bo,bn){var be=cL(az,ar,bg,bo,bn),af=fP(be.year,0,be.dayOfYear);
this.year(af.getUTCFullYear());
this.month(af.getUTCMonth());
this.date(af.getUTCDate());
return this
}eb("Q",0,"Qo","quarter");
dM("quarter","Q");
ce("Q",bC);
c8("Q",function(af,ar){ar[n]=(eI(af)-1)*3
});
function dn(af){return af==null?Math.ceil((this.month()+1)/3):this.month((af-1)*3+this.month()%3)
}eb("w",["ww",2],"wo","week");
...
ce("W",a0);
ce("WW",a0,bB);
at(["w","ww","W","WW"],function(af,be,ar,az){be[az.substr(0,1)]=eI(af)
});
function cz(af){return ht(af,this._week.dow,this._week.doy).week
}var ds={dow:0,doy:6};
function aJ(){return this._week.dow
}function ff(){return this._week.doy
}function R(af){var ar=this.localeData().week(this);
return af==null?ar:this.add((af-ar)*7,"d")
}function G(af){var ar=ht(this,1,4).week;
return af==null?ar:this.add((af-ar)*7,"d")
}eb("D",["DD",2],"Do","date");
dM("date","D");
ce("D",a0);
ce("DD",a0,bB);
ce("Do",function(ar,af){return ar?af._ordinalParse:af._ordinalParseLenient
});
c8(["D","DD"],hx);
c8("Do",function(af,ar){ar[hx]=eI(af.match(a0)[0],10)
});
var dW=gS("Date",true);
eb("d",0,"do","day");
...
eb("dddd",0,0,function(af){return this.localeData().weekdays(this,af)
});
eb("e",0,0,"weekday");
eb("E",0,0,"isoWeekday");
dM("day","d");
...
ce("dddd",function(ar,af){return af.weekdaysRegex(ar)
});
at(["dd","ddd","dddd"],function(af,be,ar,az){var bg=ar._locale.weekdaysParse(af,az,ar._strict);
if(bg!=null){be.d=bg
}else{cb(ar).invalidWeekday=af
}});
at(["d","e","E"],function(af,be,ar,az){be[az]=eI(af)
});
function cl(ar,af){if(typeof ar!=="string"){return ar
}if(!isNaN(ar)){return parseInt(ar,10)
}ar=af.weekdaysParse(ar);
if(typeof ar==="number"){return ar
}return null
}var ag="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_");
function bb(af,ar){return aj(this._weekdays)?this._weekdays[af.day()]:this._weekdays[this._weekdays.isFormat.test(ar)?"format":"standalone"][af.day()]
}var q="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");
function W(af){return this._weekdaysShort[af.day()]
}var cE="Su_Mo_Tu_We_Th_Fr_Sa".split("_");
function hU(af){return this._weekdaysMin[af.day()]
}function dl(bn,bo,af){var az,be,bg,ar=bn.toLocaleLowerCase();
...
}}}}}}function hd(ar){if(!this.isValid()){return ar!=null?this:NaN
}var af=this._isUTC?this._d.getUTCDay():this._d.getDay();
if(ar!=null){ar=cl(ar,this.localeData());
return this.add(ar-af,"d")
}else{return af
}}function aB(af){if(!this.isValid()){return af!=null?this:NaN
}var ar=(this.day()+7-this.localeData()._week.dow)%7;
return af==null?ar:this.add(af-ar,"d")
}function d7(af){if(!this.isValid()){return af!=null?this:NaN
}return af==null?this.day()||7:this.day(this.day()%7?af:af-7)
}var ax=b4;
...
function M(af){if(this._weekdaysParseExact){if(!fF(this,"_weekdaysRegex")){I.call(this)
}if(af){return this._weekdaysMinStrictRegex
}else{return this._weekdaysMinRegex
}}else{return this._weekdaysMinStrictRegex&&af?this._weekdaysMinStrictRegex:this._weekdaysMinRegex
}}function I(){function be(cv,cs){return cs.length-cv.length
}var bn=[],bo=[],ca=[],af=[],bg,az,ar,br,bs;
for(bg=0;
bg<7;
bg++){az=g6([2000,1]).day(bg);
ar=this.weekdaysMin(az,"");
br=this.weekdaysShort(az,"");
bs=this.weekdays(az,"");
bn.push(ar);
bo.push(br);
ca.push(bs);
...
ca[bg]=dN(ca[bg]);
af[bg]=dN(af[bg])
}this._weekdaysRegex=new RegExp("^("+af.join("|")+")","i");
this._weekdaysShortRegex=this._weekdaysRegex;
this._weekdaysMinRegex=this._weekdaysRegex;
this._weekdaysStrictRegex=new RegExp("^("+ca.join("|")+")","i");
this._weekdaysShortStrictRegex=new RegExp("^("+bo.join("|")+")","i");
this._weekdaysMinStrictRegex=new RegExp("^("+bn.join("|")+")","i")
}eb("DDD",["DDDD",3],"DDDo","dayOfYear");
dM("dayOfYear","DDD");
ce("DDD",aZ);
ce("DDDD",bA);
c8(["DDD","DDDD"],function(af,az,ar){ar._dayOfYear=eI(af)
});
function ci(af){var ar=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/86400000)+1;
return af==null?ar:this.add((af-ar),"d")
}function fV(){return this.hours()%12||12
}function X(){return this.hours()||24
}eb("H",["HH",2],0,"hour");
eb("h",["hh",2],0,fV);
eb("k",["kk",2],0,X);
eb("hmm",0,0,function(){return""+fV.apply(this)+dX(this.minutes(),2)
});
eb("hmmss",0,0,function(){return""+fV.apply(this)+dX(this.minutes(),2)+dX(this.seconds(),2)
});
eb("Hmm",0,0,function(){return""+this.hours()+dX(this.minutes(),2)
});
eb("Hmmss",0,0,function(){return""+this.hours()+dX(this.minutes(),2)+dX(this.seconds(),2)
});
function hl(af,ar){eb(af,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),ar)
})
}hl("a",true);
hl("A",false);
dM("hour","h");
function ac(ar,af){return af._meridiemParse
}ce("a",ac);
ce("A",ac);
ce("H",a0);
ce("h",a0);
...
ce("Hmmss",gV);
c8(["H","HH"],h0);
c8(["a","A"],function(af,az,ar){ar._isPm=ar._locale.isPM(af);
ar._meridiem=af
});
c8(["h","hh"],function(af,az,ar){az[h0]=eI(af);
cb(ar).bigHour=true
});
c8("hmm",function(af,be,ar){var az=af.length-2;
be[h0]=eI(af.substr(0,az));
be[f9]=eI(af.substr(az));
cb(ar).bigHour=true
});
c8("hmmss",function(af,bg,ar){var be=af.length-4;
var az=af.length-2;
bg[h0]=eI(af.substr(0,be));
bg[f9]=eI(af.substr(be,2));
bg[aN]=eI(af.substr(az));
cb(ar).bigHour=true
});
c8("Hmm",function(af,be,ar){var az=af.length-2;
be[h0]=eI(af.substr(0,az));
...
function dJ(af){return((af+"").toLowerCase().charAt(0)==="p")
}var dx=/[ap]\.?m?\.?/i;
function bM(af,ar,az){if(af>11){return az?"pm":"PM"
}else{return az?"am":"AM"
}}var d1=gS("Hours",true);
eb("m",["mm",2],0,"minute");
dM("minute","m");
ce("m",a0);
ce("mm",a0,bB);
...
eb(0,["SS",2],0,function(){return ~~(this.millisecond()/10)
});
...
eb(0,["SSSSSSSSS",9],0,function(){return this.millisecond()*1000000
});
dM("millisecond","ms");
ce("S",aZ,bC);
ce("SS",aZ,bB);
...
}function g2(){return this._isUTC?"Coordinated Universal Time":""
}var fu=hs.prototype;
fu.add=dP;
fu.calendar=dK;
fu.clone=fM;
...
var a=fu;
function fq(af){return gJ(af*1000)
}function h5(){return gJ.apply(null,arguments).parseZone()
}var dS={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"};
function ak(az,be,ar){var af=this._calendar[az];
return b2(af)?af.call(be,ar):af
}var gw={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"};
function eC(af){var ar=this._longDateFormat[af],az=this._longDateFormat[af.toUpperCase()];
if(ar||!az){return ar
}this._longDateFormat[af]=az.replace(/MMMM|MM|DD|dddd/g,function(be){return be.slice(1)
});
return this._longDateFormat[af]
}var aV="Invalid date";
function ho(){return this._invalidDate
}var dA="%d";
var cF=/\d{1,2}/;
function hQ(af){return this._ordinal.replace("%d",af)
}function fU(af){return af
}var hP={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"};
function dV(be,az,ar,bg){var af=this._relativeTime[ar];
return(b2(af))?af(be,az,ar,bg):af.replace(/%d/i,be)
}function gy(az,af){var ar=this._relativeTime[az>0?"future":"past"];
return b2(ar)?ar(af):ar.replace(/%s/i,af)
}var fd=eh.prototype;
fd._calendar=dS;
fd.calendar=ak;
...
fd.meridiem=bM;
function b6(bg,ar,be,bn){var af=A();
var az=g6().set(bn,ar);
return af[be](az,bg)
}function bR(bg,ar,be){if(typeof bg==="number"){ar=bg;
bg=undefined
}bg=bg||"";
...
}function dR(ar,af){return bR(ar,af,"monthsShort")
}function b1(ar,az,af){return iu(ar,az,af,"weekdays")
}function ip(ar,az,af){return iu(ar,az,af,"weekdaysShort")
}function V(ar,az,af){return iu(ar,az,af,"weekdaysMin")
}ez("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(az){var af=az%10,ar=(eI(az%100/10)===1)?"th":(af===1)?"st":(af===2)?"nd":(af===3)?"rd":"th";
return az+ar
}});
...
var hK=Math.abs;
function aR(){var af=this._data;
this._milliseconds=hK(this._milliseconds);
this._days=hK(this._days);
this._months=hK(this._months);
af.milliseconds=hK(af.milliseconds);
af.seconds=hK(af.seconds);
af.minutes=hK(af.minutes);
af.hours=hK(af.hours);
af.months=hK(af.months);
af.years=hK(af.years);
return this
}function cw(bg,ar,az,be){var af=gX(ar,az);
bg._milliseconds+=be*af._milliseconds;
bg._days+=be*af._days;
bg._months+=be*af._months;
return bg._bubble()
}function cA(af,ar){return cw(this,af,ar,1)
}function fX(af,ar){return cw(this,af,ar,-1)
}function hW(af){if(af<0){return Math.floor(af)
}else{return Math.ceil(af)
}}function eR(){var az=this._milliseconds;
var bs=this._days;
var af=this._months;
var bg=this._data;
var br,be,bo,bn,ar;
if(!((az>=0&&bs>=0&&af>=0)||(az<=0&&bs<=0&&af<=0))){az+=hW(iy(af)+bs)*86400000;
bs=0;
af=0
}bg.milliseconds=az%1000;
br=fB(az/1000);
bg.seconds=br%60;
be=fB(br/60);
bg.minutes=be%60;
...
bg.years=bn;
return this
}function k(af){return af*4800/146097
}function iy(af){return af*146097/4800
}function h1(ar){var be;
var af;
var az=this._milliseconds;
ar=eH(ar);
if(ar==="month"||ar==="year"){be=this._days+az/86400000;
af=this._months+k(be);
return ar==="month"?af:af/12
}else{be=this._days+Math.round(iy(this._months));
switch(ar){case"week":return be/7+az/604800000;
case"day":return be+az/86400000;
case"hour":return be*24+az/3600000;
case"minute":return be*1440+az/60000;
case"second":return be*86400+az/1000;
case"millisecond":return Math.floor(be*86400000)+az;
default:throw new Error("Unknown unit "+ar)
}}}function eT(){return(this._milliseconds+this._days*86400000+(this._months%12)*2592000000+eI(this._months/12)*31536000000)
}function gK(af){return function(){return this.as(af)
}
}var iz=gK("ms");
var U=gK("s");
var fO=gK("m");
...
var gH=gK("M");
var co=gK("y");
function cq(af){af=eH(af);
return this[af+"s"]()
}function dE(af){return function(){return this._data[af]
}
}var e=dE("milliseconds");
var ck=dE("seconds");
var bp=dE("minutes");
var ai=dE("hours");
var cf=dE("days");
var gR=dE("months");
var cT=dE("years");
function gU(){return fB(this.days()/7)
}var e2=Math.round;
var f8={s:45,m:45,h:22,d:26,M:11};
function aT(ar,be,az,bg,af){return af.relativeTime(be||1,!!az,ar,bg)
}function fp(bg,ar,bs){var az=gX(bg).abs();
var ca=e2(az.as("s"));
var be=e2(az.as("m"));
var br=e2(az.as("h"));
var cs=e2(az.as("d"));
var af=e2(az.as("M"));
var bn=e2(az.as("y"));
var bo=ca<f8.s&&["s",ca]||be<=1&&["m"]||be<f8.m&&["mm",be]||br<=1&&["h"]||br<f8.h&&["hh",br]||cs<=1&&["d"]||cs<f8.d&&["dd",cs]||af<=1&&["M"]||af<f8.M&&["MM",af]||bn<=1&&["y"]||["yy",bn];
bo[2]=ar;
bo[3]=+bg>0;
bo[4]=bs;
return aT.apply(null,bo)
}function b5(af,ar){if(f8[af]===undefined){return false
}if(ar===undefined){return f8[af]
}f8[af]=ar;
return true
}function c(az){var af=this.localeData();
var ar=fp(this,!az,af);
if(az){ar=af.pastFuture(+this,ar)
}return af.postformat(ar)
}var bP=Math.abs;
function ia(){var cs=bP(this._milliseconds)/1000;
var cv=bP(this._days);
var az=bP(this._months);
var bg,ca,bo;
bg=fB(cs/60);
ca=fB(bg/60);
cs%=60;
...
var be=bg;
var cy=cs;
var bs=this.asSeconds();
if(!bs){return"P0D"
}return(bs<0?"-":"")+"P"+(ar?ar+"Y":"")+(br?br+"M":"")+(af?af+"D":"")+((bn||be||cy)?"T":"")+(bn?bn+"H":"")+(be?be+"M":"")+(cy?cy+"S":"")
}var gG=gj.prototype;
gG.abs=aR;
gG.add=cA;
gG.subtract=fX;
...
ce("x",K);
ce("X",il);
c8("X",function(af,az,ar){ar._d=new Date(parseFloat(af,10)*1000)
});
c8("x",function(af,az,ar){ar._d=new Date(eI(af))
});
c7.version="2.13.0";
bK(gJ);
c7.fn=a;
...
},meridiem:function(af,ar,az){if(af<12){return az?"vm":"VM"
}else{return az?"nm":"NM"
...
},dq={s:["أقل من ثانية","ثانية واحدة",["ثانيتان","ثانيتين"],"%d ثوان","%d ثانية","%d ثانية"],m:["أقل من دقيقة","دقيقة واحدة",["دقيقتان","دقيقتين"],"%d دقائق","%d دقيقة","%d دقيقة"],h:["أقل من ساعة","ساعة واحدة",["ساعتان","ساعتين"],"%d ساعات","%d ساعة","%d ساعة"],d:["أقل من يوم","يوم واحد",["يومان","يومين"],"%d أيام","%d يومًا","%d يوم"],M:["أقل من شهر","شهر واحد",["شهران","شهرين"],"%d أشهر","%d شهرا","%d شهر"],y:["أقل من عام","عام واحد",["عامان","عامين"],"%d أعوام","%d عامًا","%d عام"]},gb=function(af){return function(be,az,ar,bn){var bg=bj(be),bo=dq[af][bj(be)];
if(bg===2){bo=bo[az?0:1]
}return bo.replace(/%d/i,be)
}
},bE=["كانون الثاني يناير","شباط فبراير","آذار مارس","نيسان أبريل","أيار مايو","حزيران يونيو","تموز يوليو","آب أغسطس","أيلول سبتمبر","تشرين الأول أكتوبر","تشرين الثاني نوفمبر","كانون الأول ديسمبر"];
...
},postformat:function(af){return af.replace(/\d/g,function(ar){return z[ar]
}).replace(/,/g,"،")
},week:{dow:6,doy:12}});
var fD={1:"-inci",5:"-inci",8:"-inci",70:"-inci",80:"-inci",2:"-nci",7:"-nci",20:"-nci",50:"-nci",3:"-üncü",4:"-üncü",100:"-üncü",6:"-ncı",9:"-uncu",10:"-uncu",30:"-uncu",60:"-ıncı",90:"-ıncı"};
...
}}}},ordinalParse:/\d{1,2}-(ıncı|inci|nci|üncü|ncı|uncu)/,ordinal:function(az){if(az===0){return az+"-ıncı"
}var ar=az%10,af=az%100-ar,be=az>=100?100:null;
return az+(fD[ar]||fD[af]||fD[be])
},week:{dow:1,doy:7}});
function aq(az,ar){var af=az.split("_");
return ar%10===1&&ar%100!==11?af[0]:(ar%10>=2&&ar%10<=4&&(ar%100<10||ar%100>=20)?af[1]:af[2])
}function fG(az,ar,af){var be={mm:ar?"хвіліна_хвіліны_хвілін":"хвіліну_хвіліны_хвілін",hh:ar?"гадзіна_гадзіны_гадзін":"гадзіну_гадзіны_гадзін",dd:"дзень_дні_дзён",MM:"месяц_месяцы_месяцаў",yy:"год_гады_гадоў"};
if(af==="m"){return ar?"хвіліна":"хвіліну"
}else{if(af==="h"){return ar?"гадзіна":"гадзіну"
...
var hz=N.defineLocale("bn",{months:"জানুয়ারী_ফেবুয়ারী_মার্চ_এপ্রিল_মে_জুন_জুলাই_অগাস্ট_সেপ্টেম্বর_অক্টোবর_নভেম্বর_ডিসেম্বর".split("_"),monthsShort:"জানু_ফেব_মার্চ_এপর_মে_জুন_জুল_অগ_সেপ্ট_অক্টো_নভ_ডিসেম্".split("_"),weekdays:"রবিবার_সোমবার_মঙ্গলবার_বুধবার_বৃহস্পত্তিবার_শুক্রবার_শনিবার".split("_"),weekdaysShort:"রবি_সোম_মঙ্গল_বুধ_বৃহস্পত্তি_শুক্র_শনি".split("_"),weekdaysMin:"রব_সম_মঙ্গ_বু_ব্রিহ_শু_শনি".split("_"),longDateFormat:{LT:"A h:mm সময়",LTS:"A h:mm:ss সময়",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm সময়",LLLL:"dddd, D MMMM YYYY, A h:mm সময়"},calendar:{sameDay:"[আজ] LT",nextDay:"[আগামীকাল] LT",nextWeek:"dddd, LT",lastDay:"[গতকাল] LT",lastWeek:"[গত] dddd, LT",sameElse:"L"},relativeTime:{future:"%s পরে",past:"%s আগে",s:"কয়েক সেকেন্ড",m:"এক মিনিট",mm:"%d মিনিট",h:"এক ঘন্টা",hh:"%d ঘন্টা",d:"এক দিন",dd:"%d দিন",M:"এক মাস",MM:"%d মাস",y:"এক বছর",yy:"%d বছর"},preparse:function(af){return af.replace(/[১২৩৪৫৬৭৮৯০]/g,function(ar){return dz[ar]
})
...
}},meridiem:function(af,az,ar){if(af<4){return"রাত"
}else{if(af<10){return"সকাল"
}else{if(af<17){return"দুপুর"
...
}else{if(af<10){return"ཞོགས་ཀས"
}else{if(af<17){return"ཉིན་གུང"
}else{if(af<20){return"དགོང་དག"
}else{return"མཚན་མོ"
}}}}},week:{dow:0,doy:6}});
function g(az,ar,af){var be={mm:"munutenn",MM:"miz",dd:"devezh"};
return az+" "+hN(be[af],az)
}function aM(af){switch(eE(af)){case 1:case 3:case 4:case 5:case 9:return af+" bloaz";
default:return af+" vloaz"
}}function eE(af){if(af>9){return eE(af%10)
}return af
...
}},sameElse:"L"},relativeTime:{future:"za %s",past:"prije %s",s:"par sekundi",m:dy,mm:dy,h:dy,hh:dy,d:"dan",dd:dy,M:"mjesec",MM:dy,y:"godinu",yy:dy},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:7}});
...
}},sameElse:"L"},relativeTime:{future:"za %s",past:"před %s",s:fZ,m:fZ,mm:fZ,h:fZ,hh:fZ,d:fZ,dd:fZ,M:fZ,MM:fZ,y:fZ,yy:fZ},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
var g7=N.defineLocale("cv",{months:"кӑрлач_нарӑс_пуш_ака_май_ҫӗртме_утӑ_ҫурла_авӑн_юпа_чӳк_раштав".split("_"),monthsShort:"кӑр_нар_пуш_ака_май_ҫӗр_утӑ_ҫур_авн_юпа_чӳк_раш".split("_"),weekdays:"вырсарникун_тунтикун_ытларикун_юнкун_кӗҫнерникун_эрнекун_шӑматкун".split("_"),weekdaysShort:"выр_тун_ытл_юн_кӗҫ_эрн_шӑм".split("_"),weekdaysMin:"вр_тн_ыт_юн_кҫ_эр_шм".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD-MM-YYYY",LL:"YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ]",LLL:"YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ], HH:mm",LLLL:"dddd, YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ], HH:mm"},calendar:{sameDay:"[Паян] LT [сехетре]",nextDay:"[Ыран] LT [сехетре]",lastDay:"[Ӗнер] LT [сехетре]",nextWeek:"[Ҫитес] dddd LT [сехетре]",lastWeek:"[Иртнӗ] dddd LT [сехетре]",sameElse:"L"},relativeTime:{future:function(ar){var af=/сехет$/i.exec(ar)?"рен":/ҫул$/i.exec(ar)?"тан":"ран";
return ar+af
...
if(af>20){if(af===40||af===50||af===60||af===80||af===100){ar="fed"
}else{ar="ain"
...
var iv="ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),f="ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_");
var gt=N.defineLocale("es",{months:"Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split("_"),monthsShort:function(af,ar){if(/-MMM-/.test(ar)){return f[af.month()]
...
}var ga=N.defineLocale("fi",{months:"tammikuu_helmikuu_maaliskuu_huhtikuu_toukokuu_kesäkuu_heinäkuu_elokuu_syyskuu_lokakuu_marraskuu_joulukuu".split("_"),monthsShort:"tammi_helmi_maalis_huhti_touko_kesä_heinä_elo_syys_loka_marras_joulu".split("_"),weekdays:"sunnuntai_maanantai_tiistai_keskiviikko_torstai_perjantai_lauantai".split("_"),weekdaysShort:"su_ma_ti_ke_to_pe_la".split("_"),weekdaysMin:"su_ma_ti_ke_to_pe_la".split("_"),longDateFormat:{LT:"HH.mm",LTS:"HH.mm.ss",L:"DD.MM.YYYY",LL:"Do MMMM[ta] YYYY",LLL:"Do MMMM[ta] YYYY, [klo] HH.mm",LLLL:"dddd, Do MMMM[ta] YYYY, [klo] HH.mm",l:"D.M.YYYY",ll:"Do MMM YYYY",lll:"Do MMM YYYY, [klo] HH.mm",llll:"ddd, Do MMM YYYY, [klo] HH.mm"},calendar:{sameDay:"[tänään] [klo] LT",nextDay:"[huomenna] [klo] LT",nextWeek:"dddd [klo] LT",lastDay:"[eilen] [klo] LT",lastWeek:"[viime] dddd[na] [klo] LT",sameElse:"L"},relativeTime:{future:"%s päästä",past:"%s sitten",s:Z,m:Z,mm:Z,h:Z,hh:Z,d:Z,dd:Z,M:Z,MM:Z,y:Z,yy:Z},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
var f5=N.defineLocale("fo",{months:"januar_februar_mars_apríl_mai_juni_juli_august_september_oktober_november_desember".split("_"),monthsShort:"jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"),weekdays:"sunnudagur_mánadagur_týsdagur_mikudagur_hósdagur_fríggjadagur_leygardagur".split("_"),weekdaysShort:"sun_mán_týs_mik_hós_frí_ley".split("_"),weekdaysMin:"su_má_tý_mi_hó_fr_le".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D. MMMM, YYYY HH:mm"},calendar:{sameDay:"[Í dag kl.] LT",nextDay:"[Í morgin kl.] LT",nextWeek:"dddd [kl.] LT",lastDay:"[Í gjár kl.] LT",lastWeek:"[síðstu] dddd [kl] LT",sameElse:"L"},relativeTime:{future:"um %s",past:"%s síðani",s:"fá sekund",m:"ein minutt",mm:"%d minuttir",h:"ein tími",hh:"%d tímar",d:"ein dagur",dd:"%d dagar",M:"ein mánaði",MM:"%d mánaðir",y:"eitt ár",yy:"%d ár"},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
var hZ=N.defineLocale("fr-ca",{months:"janvier_février_mars_avril_mai_juin_juillet_août_septembre_octobre_novembre_décembre".split("_"),monthsShort:"janv._févr._mars_avr._mai_juin_juil._août_sept._oct._nov._déc.".split("_"),monthsParseExact:true,weekdays:"dimanche_lundi_mardi_mercredi_jeudi_vendredi_samedi".split("_"),weekdaysShort:"dim._lun._mar._mer._jeu._ven._sam.".split("_"),weekdaysMin:"Di_Lu_Ma_Me_Je_Ve_Sa".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY-MM-DD",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D MMMM YYYY HH:mm"},calendar:{sameDay:"[Aujourd'hui à] LT",nextDay:"[Demain à] LT",nextWeek:"dddd [à] LT",lastDay:"[Hier à] LT",lastWeek:"dddd [dernier à] LT",sameElse:"L"},relativeTime:{future:"dans %s",past:"il y a %s",s:"quelques secondes",m:"une minute",mm:"%d minutes",h:"une heure",hh:"%d heures",d:"un jour",dd:"%d jours",M:"un mois",MM:"%d mois",y:"un an",yy:"%d ans"},ordinalParse:/\d{1,2}(er|e)/,ordinal:function(af){return af+(af===1?"er":"e")
}});
...
var fS=N.defineLocale("gl",{months:"Xaneiro_Febreiro_Marzo_Abril_Maio_Xuño_Xullo_Agosto_Setembro_Outubro_Novembro_Decembro".split("_"),monthsShort:"Xan._Feb._Mar._Abr._Mai._Xuñ._Xul._Ago._Set._Out._Nov._Dec.".split("_"),monthsParseExact:true,weekdays:"Domingo_Luns_Martes_Mércores_Xoves_Venres_Sábado".split("_"),weekdaysShort:"Dom._Lun._Mar._Mér._Xov._Ven._Sáb.".split("_"),weekdaysMin:"Do_Lu_Ma_Mé_Xo_Ve_Sá".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY H:mm",LLLL:"dddd D MMMM YYYY H:mm"},calendar:{sameDay:function(){return"[hoxe "+((this.hours()!==1)?"ás":"á")+"] LT"
...
}else{if(af<18){return ar?'אחה"צ':"אחרי הצהריים"
}else{return"בערב"
}}}}}});
var ey={"1":"१","2":"२","3":"३","4":"४","5":"५","6":"६","7":"७","8":"८","9":"९","0":"०"},fv={"१":"1","२":"2","३":"3","४":"4","५":"5","६":"6","७":"7","८":"8","९":"9","०":"0"};
...
case"MM":return af+(bn||az?" hónap":" hónapja");
case"y":return"egy"+(bn||az?" év":" éve");
case"yy":return af+(bn||az?" év":" éve")
}return""
...
},sameElse:"L"},relativeTime:{future:"%s հետո",past:"%s առաջ",s:"մի քանի վայրկյան",m:"րոպե",mm:"%d րոպե",h:"ժամ",hh:"%d ժամ",d:"օր",dd:"%d օր",M:"ամիս",MM:"%d ամիս",y:"տարի",yy:"%d տարի"},meridiemParse:/գիշերվա|առավոտվա|ցերեկվա|երեկոյան/,isPM:function(af){return/^(ցերեկվա|երեկոյան)$/.test(af)
},meridiem:function(af){if(af<4){return"գիշերվա"
}else{if(af<12){return"առավոտվա"
}else{if(af<17){return"ցերեկվա"
}else{return"երեկոյան"
}}}},ordinalParse:/\d{1,2}|\d{1,2}-(ին|րդ)/,ordinal:function(af,ar){switch(ar){case"DDD":case"w":case"W":case"DDDo":if(af===1){return af+"-ին"
}return af+"-րդ";
default:return af
}},week:{dow:1,doy:7}});
...
}},sameElse:"L"},relativeTime:{future:function(af){return((/^[0-9].+$/).test(af)?"tra":"in")+" "+af
...
var er=N.defineLocale("jv",{months:"Januari_Februari_Maret_April_Mei_Juni_Juli_Agustus_September_Oktober_Nopember_Desember".split("_"),monthsShort:"Jan_Feb_Mar_Apr_Mei_Jun_Jul_Ags_Sep_Okt_Nop_Des".split("_"),weekdays:"Minggu_Senen_Seloso_Rebu_Kemis_Jemuwah_Septu".split("_"),weekdaysShort:"Min_Sen_Sel_Reb_Kem_Jem_Sep".split("_"),weekdaysMin:"Mg_Sn_Sl_Rb_Km_Jm_Sp".split("_"),longDateFormat:{LT:"HH.mm",LTS:"HH.mm.ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY [pukul] HH.mm",LLLL:"dddd, D MMMM YYYY [pukul] HH.mm"},meridiemParse:/enjing|siyang|sonten|ndalu/,meridiemHour:function(af,ar){if(af===12){af=0
...
return af[this.day()]
},sameElse:"L"},relativeTime:{future:"za %s",past:"prije %s",s:"nekoliko sekundi",m:cn.translate,mm:cn.translate,h:cn.translate,hh:cn.translate,d:"dan",dd:cn.translate,M:"mjesec",MM:cn.translate,y:"godinu",yy:cn.translate},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:7}});
...
}if((ar==="രാത്രി"&&af>=4)||ar==="ഉച്ച കഴിഞ്ഞ്"||ar==="വൈകുന്നേരം"){return af+12
}else{return af
}},meridiem:function(af,az,ar){if(af<4){return"രാത്രി"
}else{if(af<12){return"രാവിലെ"
}else{if(af<17){return"ഉച്ച കഴിഞ്ഞ്"
}else{if(af<20){return"വൈകുന്നേരം"
}else{return"രാത്രി"
}}}}}});
var dY={"1":"१","2":"२","3":"३","4":"४","5":"५","6":"६","7":"७","8":"८","9":"९","0":"०"},eZ={"१":"1","२":"2","३":"3","४":"4","५":"5","६":"6","७":"7","८":"8","९":"9","०":"0"};
...
case"yy":af="%d वर्षे";
break
}}else{switch(ar){case"s":af="काही सेकंदां";
break;
case"m":af="एका मिनिटा";
break;
case"mm":af="%d मिनिटां";
break;
case"h":af="एका तासा";
break;
case"hh":af="%d तासां";
...
},meridiemParse:/रात्री|सकाळी|दुपारी|सायंकाळी/,meridiemHour:function(af,ar){if(af===12){af=0
}if(ar==="रात्री"){return af<4?af:af+12
...
var c3=N.defineLocale("ne",{months:"जनवरी_फेब्रुवरी_मार्च_अप्रिल_मई_जुन_जुलाई_अगष्ट_सेप्टेम्बर_अक्टोबर_नोभेम्बर_डिसेम्बर".split("_"),monthsShort:"जन._फेब्रु._मार्च_अप्रि._मई_जुन_जुलाई._अग._सेप्ट._अक्टो._नोभे._डिसे.".split("_"),monthsParseExact:true,weekdays:"आइतबार_सोमबार_मङ्गलबार_बुधबार_बिहिबार_शुक्रबार_शनिबार".split("_"),weekdaysShort:"आइत._सोम._मङ्गल._बुध._बिहि._शुक्र._शनि.".split("_"),weekdaysMin:"आ._सो._मं._बु._बि._शु._श.".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"Aको h:mm बजे",LTS:"Aको h:mm:ss बजे",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, Aको h:mm बजे",LLLL:"dddd, D MMMM YYYY, Aको h:mm बजे"},preparse:function(af){return af.replace(/[१२३४५६७८९०]/g,function(ar){return bD[ar]
})
},postformat:function(af){return af.replace(/\d/g,function(ar){return aI[ar]
})
},meridiemParse:/राति|बिहान|दिउँसो|साँझ/,meridiemHour:function(af,ar){if(af===12){af=0
}if(ar==="राति"){return af<4?af:af+12
}else{if(ar==="बिहान"){return af
}else{if(ar==="दिउँसो"){return af>=10?af:af+12
}else{if(ar==="साँझ"){return af+12
}}}}},meridiem:function(af,az,ar){if(af<3){return"राति"
}else{if(af<12){return"बिहान"
}else{if(af<16){return"दिउँसो"
...
var h6="jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),gv="jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_");
var cW=N.defineLocale("nl",{months:"januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),monthsShort:function(af,ar){if(/-MMM-/.test(ar)){return gv[af.month()]
...
}},sameElse:"L"},relativeTime:{future:"za %s",past:"%s temu",s:"kilka sekund",m:eK,mm:eK,h:eK,hh:eK,d:"1 dzień",dd:"%d dni",M:"miesiąc",MM:eK,y:"rok",yy:eK},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
...
var bd=N.defineLocale("si",{months:"ජනවාරි_පෙබරවාරි_මාර්තු_අප්රේල්_මැයි_ජූනි_ජූලි_අගෝස්තු_සැප්තැම්බර්_ඔක්තෝබර්_නොවැම්බර්_දෙසැම්බර්".split("_"),monthsShort:"ජන_පෙබ_මාර්_අප්_මැයි_ජූනි_ජූලි_අගෝ_සැප්_ඔක්_නොවැ_දෙසැ".split("_"),weekdays:"ඉරිදා_සඳුදා_අඟහරුවාදා_බදාදා_බ්රහස්පතින්දා_සිකුරාදා_සෙනසුරාදා".split("_"),weekdaysShort:"ඉරි_සඳු_අඟ_බදා_බ්රහ_සිකු_සෙන".split("_"),weekdaysMin:"ඉ_ස_අ_බ_බ්ර_සි_සෙ".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"a h:mm",LTS:"a h:mm:ss",L:"YYYY/MM/DD",LL:"YYYY MMMM D",LLL:"YYYY MMMM D, a h:mm",LLLL:"YYYY MMMM D [වැනි] dddd, a h:mm:ss"},calendar:{sameDay:"[අද] LT[ට]",nextDay:"[හෙට] LT[ට]",nextWeek:"dddd LT[ට]",lastDay:"[ඊයේ] LT[ට]",lastWeek:"[පසුගිය] dddd LT[ට]",sameElse:"L"},relativeTime:{future:"%sකින්",past:"%sකට පෙර",s:"තත්පර කිහිපය",m:"මිනිත්තුව",mm:"මිනිත්තු %d",h:"පැය",hh:"පැය %d",d:"දිනය",dd:"දින %d",M:"මාසය",MM:"මාස %d",y:"වසර",yy:"වසර %d"},ordinalParse:/\d{1,2} වැනි/,ordinal:function(af){return af+" වැනි"
},meridiemParse:/පෙර වරු|පස් වරු|පෙ.ව|ප.ව./,isPM:function(af){return af==="ප.ව."||af==="පස් වරු"
},meridiem:function(af,ar,az){if(af>11){return az?"ප.ව.":"පස් වරු"
}else{return az?"පෙ.ව.":"පෙර වරු"
}}});
var e1="január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_"),j="jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_");
function bU(af){return(af>1)&&(af<5)
}function h8(be,az,ar,bg){var af=be+" ";
switch(ar){case"s":return(az||bg)?"pár sekúnd":"pár sekundami";
case"m":return az?"minúta":(bg?"minútu":"minútou");
case"mm":if(az||bg){return af+(bU(be)?"minúty":"minút")
}else{return af+"minútami"
}break;
case"h":return az?"hodina":(bg?"hodinu":"hodinou");
case"hh":if(az||bg){return af+(bU(be)?"hodiny":"hodín")
}else{return af+"hodinami"
}break;
...
return af[this.day()]
},sameElse:"L"},relativeTime:{future:"за %s",past:"пре %s",s:"неколико секунди",m:hC.translate,mm:hC.translate,h:hC.translate,hh:hC.translate,d:"дан",dd:hC.translate,M:"месец",MM:hC.translate,y:"годину",yy:hC.translate},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:7}});
var s={words:{m:["jedan minut","jedne minute"],mm:["minut","minute","minuta"],h:["jedan sat","jednog sata"],hh:["sat","sata","sati"],dd:["dan","dana","dana"],MM:["mesec","meseca","meseci"],yy:["godina","godine","godina"]},correctGrammaticalCase:function(ar,af){return ar===1?af[0]:(ar>=2&&ar<=4?af[1]:af[2])
},translate:function(be,ar,af){var az=s.words[af];
if(af.length===1){return ar?az[0]:az[1]
}else{return be+" "+s.correctGrammaticalCase(be,az)
}}};
var a5=N.defineLocale("sr",{months:"januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split("_"),monthsShort:"jan._feb._mar._apr._maj_jun_jul_avg._sep._okt._nov._dec.".split("_"),monthsParseExact:true,weekdays:"nedelja_ponedeljak_utorak_sreda_četvrtak_petak_subota".split("_"),weekdaysShort:"ned._pon._uto._sre._čet._pet._sub.".split("_"),weekdaysMin:"ne_po_ut_sr_če_pe_su".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"DD. MM. YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY H:mm",LLLL:"dddd, D. MMMM YYYY H:mm"},calendar:{sameDay:"[danas u] LT",nextDay:"[sutra u] LT",nextWeek:function(){switch(this.day()){case 0:return"[u] [nedelju] [u] LT";
...
var gp={"1":"௧","2":"௨","3":"௩","4":"௪","5":"௫","6":"௬","7":"௭","8":"௮","9":"௯","0":"௦"},g9={"௧":"1","௨":"2","௩":"3","௪":"4","௫":"5","௬":"6","௭":"7","௮":"8","௯":"9","௦":"0"};
...
}else{if(af<10){return"ఉదయం"
}else{if(af<17){return"మధ్యాహ్నం"
}else{if(af<20){return"సాయంత్రం"
}else{return"రాత్రి"
}}}}},week:{dow:0,doy:6}});
var aP=N.defineLocale("th",{months:"มกราคม_กุมภาพันธ์_มีนาคม_เมษายน_พฤษภาคม_มิถุนายน_กรกฎาคม_สิงหาคม_กันยายน_ตุลาคม_พฤศจิกายน_ธันวาคม".split("_"),monthsShort:"มกรา_กุมภา_มีนา_เมษา_พฤษภา_มิถุนา_กรกฎา_สิงหา_กันยา_ตุลา_พฤศจิกา_ธันวา".split("_"),monthsParseExact:true,weekdays:"อาทิตย์_จันทร์_อังคาร_พุธ_พฤหัสบดี_ศุกร์_เสาร์".split("_"),weekdaysShort:"อาทิตย์_จันทร์_อังคาร_พุธ_พฤหัส_ศุกร์_เสาร์".split("_"),weekdaysMin:"อา._จ._อ._พ._พฤ._ศ._ส.".split("_"),weekdaysParseExact:true,longDateFormat:{LT:"H นาฬิกา m นาที",LTS:"H นาฬิกา m นาที s วินาที",L:"YYYY/MM/DD",LL:"D MMMM YYYY",LLL:"D MMMM YYYY เวลา H นาฬิกา m นาที",LLLL:"วันddddที่ D MMMM YYYY เวลา H นาฬิกา m นาที"},meridiemParse:/ก่อนเที่ยง|หลังเที่ยง/,isPM:function(af){return af==="หลังเที่ยง"
},meridiem:function(af,az,ar){if(af<12){return"ก่อนเที่ยง"
...
switch(ar){case"mm":return af+" tup";
case"hh":return af+" rep";
case"dd":return af+" jaj";
case"MM":return af+" jar";
case"yy":return af+" DIS"
}}function ft(az){var bg=Math.floor((az%1000)/100),af=Math.floor((az%100)/10),ar=az%10,be="";
...
var p={1:"'inci",5:"'inci",8:"'inci",70:"'inci",80:"'inci",2:"'nci",7:"'nci",20:"'nci",50:"'nci",3:"'üncü",4:"'üncü",100:"'üncü",6:"'ncı",9:"'uncu",10:"'uncu",30:"'uncu",60:"'ıncı",90:"'ıncı"};
var aH=N.defineLocale("tr",{months:"Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık".split("_"),monthsShort:"Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_"),weekdays:"Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),weekdaysShort:"Paz_Pts_Sal_Çar_Per_Cum_Cts".split("_"),weekdaysMin:"Pz_Pt_Sa_Ça_Pe_Cu_Ct".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[bugün saat] LT",nextDay:"[yarın saat] LT",nextWeek:"[haftaya] dddd [saat] LT",lastDay:"[dün] LT",lastWeek:"[geçen hafta] dddd [saat] LT",sameElse:"L"},relativeTime:{future:"%s sonra",past:"%s önce",s:"birkaç saniye",m:"bir dakika",mm:"%d dakika",h:"bir saat",hh:"%d saat",d:"bir gün",dd:"%d gün",M:"bir ay",MM:"%d ay",y:"bir yıl",yy:"%d yıl"},ordinalParse:/\d{1,2}'(inci|nci|üncü|ncı|uncu|ıncı)/,ordinal:function(az){if(az===0){return az+"'ıncı"
}var ar=az%10,af=az%100-ar,be=az>=100?100:null;
return az+(p[ar]||p[af]||p[be])
},week:{dow:1,doy:7}});
var eP=N.defineLocale("tzl",{months:"Januar_Fevraglh_Març_Avrïu_Mai_Gün_Julia_Guscht_Setemvar_Listopäts_Noemvar_Zecemvar".split("_"),monthsShort:"Jan_Fev_Mar_Avr_Mai_Gün_Jul_Gus_Set_Lis_Noe_Zec".split("_"),weekdays:"Súladi_Lúneçi_Maitzi_Márcuri_Xhúadi_Viénerçi_Sáturi".split("_"),weekdaysShort:"Súl_Lún_Mai_Már_Xhú_Vié_Sát".split("_"),weekdaysMin:"Sú_Lú_Ma_Má_Xh_Vi_Sá".split("_"),longDateFormat:{LT:"HH.mm",LTS:"HH.mm.ss",L:"DD.MM.YYYY",LL:"D. MMMM [dallas] YYYY",LLL:"D. MMMM [dallas] YYYY HH.mm",LLLL:"dddd, [li] D. MMMM [dallas] YYYY HH.mm"},meridiemParse:/d\'o|d\'a/i,isPM:function(af){return"d'o"===af.toLowerCase()
},meridiem:function(af,ar,az){if(af>11){return az?"d'o":"D'O"
}else{return az?"d'a":"D'A"
}},calendar:{sameDay:"[oxhi à] LT",nextDay:"[demà à] LT",nextWeek:"dddd [à] LT",lastDay:"[ieiri à] LT",lastWeek:"[sür el] dddd [lasteu à] LT",sameElse:"L"},relativeTime:{future:"osprei %s",past:"ja%s",s:bq,m:bq,mm:bq,h:bq,hh:bq,d:bq,dd:bq,M:bq,MM:bq,y:bq,yy:bq},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
function bq(az,ar,af,bg){var be={s:["viensas secunds","'iensas secunds"],m:["'n míut","'iens míut"],mm:[az+" míuts",""+az+" míuts"],h:["'n þora","'iensa þora"],hh:[az+" þoras",""+az+" þoras"],d:["'n ziua","'iensa ziua"],dd:[az+" ziuas",""+az+" ziuas"],M:["'n mes","'iens mes"],MM:[az+" mesen",""+az+" mesen"],y:["'n ar","'iens ar"],yy:[az+" ars",""+az+" ars"]};
...
var eO=N.defineLocale("tzm",{months:"ⵉⵏⵏⴰⵢⵔ_ⴱⵕⴰⵢⵕ_ⵎⴰⵕⵚ_ⵉⴱⵔⵉⵔ_ⵎⴰⵢⵢⵓ_ⵢⵓⵏⵢⵓ_ⵢⵓⵍⵢⵓⵣ_ⵖⵓⵛⵜ_ⵛⵓⵜⴰⵏⴱⵉⵔ_ⴽⵟⵓⴱⵕ_ⵏⵓⵡⴰⵏⴱⵉⵔ_ⴷⵓⵊⵏⴱⵉⵔ".split("_"),monthsShort:"ⵉⵏⵏⴰⵢⵔ_ⴱⵕⴰⵢⵕ_ⵎⴰⵕⵚ_ⵉⴱⵔⵉⵔ_ⵎⴰⵢⵢⵓ_ⵢⵓⵏⵢⵓ_ⵢⵓⵍⵢⵓⵣ_ⵖⵓⵛⵜ_ⵛⵓⵜⴰⵏⴱⵉⵔ_ⴽⵟⵓⴱⵕ_ⵏⵓⵡⴰⵏⴱⵉⵔ_ⴷⵓⵊⵏⴱⵉⵔ".split("_"),weekdays:"ⴰⵙⴰⵎⴰⵙ_ⴰⵢⵏⴰⵙ_ⴰⵙⵉⵏⴰⵙ_ⴰⴽⵔⴰⵙ_ⴰⴽⵡⴰⵙ_ⴰⵙⵉⵎⵡⴰⵙ_ⴰⵙⵉⴹⵢⴰⵙ".split("_"),weekdaysShort:"ⴰⵙⴰⵎⴰⵙ_ⴰⵢⵏⴰⵙ_ⴰⵙⵉⵏⴰⵙ_ⴰⴽⵔⴰⵙ_ⴰⴽⵡⴰⵙ_ⴰⵙⵉⵎⵡⴰⵙ_ⴰⵙⵉⴹⵢⴰⵙ".split("_"),weekdaysMin:"ⴰⵙⴰⵎⴰⵙ_ⴰⵢⵏⴰⵙ_ⴰⵙⵉⵏⴰⵙ_ⴰⴽⵔⴰⵙ_ⴰⴽⵡⴰⵙ_ⴰⵙⵉⵎⵡⴰⵙ_ⴰⵙⵉⴹⵢⴰⵙ".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D MMMM YYYY HH:mm"},calendar:{sameDay:"[ⴰⵙⴷⵅ ⴴ] LT",nextDay:"[ⴰⵙⴽⴰ ⴴ] LT",nextWeek:"dddd [ⴴ] LT",lastDay:"[ⴰⵚⴰⵏⵜ ⴴ] LT",lastWeek:"dddd [ⴴ] LT",sameElse:"L"},relativeTime:{future:"ⴷⴰⴷⵅ ⵙ ⵢⴰⵏ %s",past:"ⵢⴰⵏ %s",s:"ⵉⵎⵉⴽ",m:"ⵎⵉⵏⵓⴺ",mm:"%d ⵎⵉⵏⵓⴺ",h:"ⵙⴰⵄⴰ",hh:"%d ⵜⴰⵙⵙⴰⵄⵉⵏ",d:"ⴰⵙⵙ",dd:"%d oⵙⵙⴰⵏ",M:"ⴰⵢoⵓⵔ",MM:"%d ⵉⵢⵢⵉⵔⵏ",y:"ⴰⵙⴳⴰⵙ",yy:"%d ⵉⵙⴳⴰⵙⵏ"},week:{dow:6,doy:12}});
function dg(az,ar){var af=az.split("_");
return ar%10===1&&ar%100!==11?af[0]:(ar%10>=2&&ar%10<=4&&(ar%100<10||ar%100>=20)?af[1]:af[2])
}function d3(az,ar,af){var be={mm:ar?"хвилина_хвилини_хвилин":"хвилину_хвилини_хвилин",hh:ar?"година_години_годин":"годину_години_годин",dd:"день_дні_днів",MM:"місяць_місяці_місяців",yy:"рік_роки_років"};
...
var ad=N.defineLocale("uz",{months:"январ_феврал_март_апрел_май_июн_июл_август_сентябр_октябр_ноябр_декабр".split("_"),monthsShort:"янв_фев_мар_апр_май_июн_июл_авг_сен_окт_ноя_дек".split("_"),weekdays:"Якшанба_Душанба_Сешанба_Чоршанба_Пайшанба_Жума_Шанба".split("_"),weekdaysShort:"Якш_Душ_Сеш_Чор_Пай_Жум_Шан".split("_"),weekdaysMin:"Як_Ду_Се_Чо_Па_Жу_Ша".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"D MMMM YYYY, dddd HH:mm"},calendar:{sameDay:"[Бугун соат] LT [да]",nextDay:"[Эртага] LT [да]",nextWeek:"dddd [куни соат] LT [да]",lastDay:"[Кеча соат] LT [да]",lastWeek:"[Утган] dddd [куни соат] LT [да]",sameElse:"L"},relativeTime:{future:"Якин %s ичида",past:"Бир неча %s олдин",s:"фурсат",m:"бир дакика",mm:"%d дакика",h:"бир соат",hh:"%d соат",d:"бир кун",dd:"%d кун",M:"бир ой",MM:"%d ой",y:"бир йил",yy:"%d йил"},week:{dow:1,doy:7}});
var T=N.defineLocale("vi",{months:"tháng 1_tháng 2_tháng 3_tháng 4_tháng 5_tháng 6_tháng 7_tháng 8_tháng 9_tháng 10_tháng 11_tháng 12".split("_"),monthsShort:"Th01_Th02_Th03_Th04_Th05_Th06_Th07_Th08_Th09_Th10_Th11_Th12".split("_"),monthsParseExact:true,weekdays:"chủ nhật_thứ hai_thứ ba_thứ tư_thứ năm_thứ sáu_thứ bảy".split("_"),weekdaysShort:"CN_T2_T3_T4_T5_T6_T7".split("_"),weekdaysMin:"CN_T2_T3_T4_T5_T6_T7".split("_"),weekdaysParseExact:true,meridiemParse:/sa|ch/i,isPM:function(af){return/^ch$/i.test(af)
},meridiem:function(af,ar,az){if(af<12){return az?"sa":"SA"
}else{return az?"ch":"CH"
...
},nextWeek:function(){var af,ar;
af=N().startOf("week");
ar=this.diff(af,"days")>=7?"[下]":"[本]";
return this.minutes()===0?ar+"dddAh点整":ar+"dddAh点mm"
},lastWeek:function(){var af,ar;
af=N().startOf("week");
ar=this.unix()<af.unix()?"[上]":"[本]";
return this.minutes()===0?ar+"dddAh点整":ar+"dddAh点mm"
},sameElse:"LL"},ordinalParse:/\d{1,2}(日|月|周)/,ordinal:function(af,ar){switch(ar){case"d":case"D":case"DDD":return af+"日";
case"M":return af+"月";
case"w":case"W":return af+"周";
default:return af
...
}}}}},calendar:{sameDay:"[今天]LT",nextDay:"[明天]LT",nextWeek:"[下]ddddLT",lastDay:"[昨天]LT",lastWeek:"[上]ddddLT",sameElse:"L"},ordinalParse:/\d{1,2}(日|月|週)/,ordinal:function(af,ar){switch(ar){case"d":case"D":case"DDD":return af+"日";
case"M":return af+"月";
case"w":case"W":return af+"週";
default:return af
}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",m:"1分鐘",mm:"%d分鐘",h:"1小時",hh:"%d小時",d:"1天",dd:"%d天",M:"1個月",MM:"%d個月",y:"1年",yy:"%d年"}});
var e8=N;
e8.locale("en");
return e8
}));