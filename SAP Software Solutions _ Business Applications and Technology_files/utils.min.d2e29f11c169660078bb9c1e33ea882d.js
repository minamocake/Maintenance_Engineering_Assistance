...
(function(a,b,c){b.I18n.getI18nMessage=function(j,h,i){var e=b.I18n.getLoc(),k=b.I18n.getLanguage(),d;
var g=j.toLowerCase();
var f=g.replace(/\./g,"\\.");
f="[data-"+f+"]";
d=c(f).data(g);
if(d){return b.Util.patchText(d,h)
}b.I18n.setLocale(k);
d=b.I18n.get(j,h,i);
b.I18n.setLocale(e);
return d
};
b.I18n.getLanguage=function(){return a.documentElement.getAttribute("data-language")||"en_us"
};
b.I18n.getLoc=function(){var d=CQ&&CQ.WCM&&(CQ.WCM.isEditMode()||CQ.WCM.isDesignMode()||CQ.WCM.isPreviewMode());
return d?b.I18n.getLocale():a.documentElement.lang||"en"
}
